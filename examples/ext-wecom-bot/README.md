...
Enterprise WeCom AI Bot channel extension example for Wayland.
...
- Bridging inbound message to Wayland unified channel pipeline
...
2. Open Settings -> Channels -> `WeCom AI Bot (Example)`.
3. Fill:
